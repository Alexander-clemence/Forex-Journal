...
export const TradeDetailsModal = memo(function TradeDetailsModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="min-w-[1000px] max-w-[95vw] h-[80vh] flex flex-col p-0 gap-0 bg-slate-950 border-slate-800">
        <DialogHeader className="px-8 pt-8 pb-6 border-b border-slate-800/50 flex-shrink-0">
          <DialogTitle className="text-3xl font-bold text-white tracking-tight">
            {trade.symbol} Trade Details
          </DialogTitle>
          <p className="text-base text-slate-400 font-normal mt-2">
